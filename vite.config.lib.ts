...
export interface CustomPattern { id: string; name: string; category?: string; src?: string; shape?: ObjectShape; color?: string; width: number; depth: number; height?: number; snapToWall?: boolean }
...
export interface SaveEvent { project: Project; source: SaveSource; savedAt: Date }
...
export interface Project { id: string; name: string; description?: string; floors: Floor[]; activeFloorId: string; createdAt: Date; updatedAt: Date; wallHeight: number; customPatterns?: CustomPattern[] }
